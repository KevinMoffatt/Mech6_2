...
void setup()  
{
  ...
  Serial.println("<a> paddle, <b> wall lift, <c> U turn, <d> rail runners, <e> warped wall");
...
void loop() // run over and over
{
  ...
  delay(1000); //minimum delay for showNewData to output correctly, if this is not a concern, set the delay to 3.
  showNewData();
  if(String(receivedChars) == "a"){
    mySerial.write(255);
    mySerial.write(1);
    goIter++;
